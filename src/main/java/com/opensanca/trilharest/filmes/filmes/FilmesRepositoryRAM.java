...
public class FilmesRepositoryRAM implements FilmesRepository {
    ...
    @Override
    public Pagina<Filme> buscarPaginaEmExbicao(ParametrosDePaginacao parametrosDePaginacao, LocalDate referencia) {
    ...
    public Filme buscarPorId(UUID id) {
        return registros.stream()
                ...
                .findFirst()
                .orElseThrow(
                        () -> new IllegalArgumentException("Não encontro")
                );
    }
}
